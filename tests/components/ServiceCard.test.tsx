...
describe('ServiceCard', () => {
  const mockService = {
    ...
    shortDescription: 'Complete weekly pool cleaning and maintenance service',
    features: [
      'Chemical balancing',
      'Debris removal',
      'Filter cleaning',
  ...
  it('should render service information', () => {
    ...
    expect(screen.getByText(/starting at \$120/i)).toBeInTheDocument()
  })
  ...
  it('should render contact button', () => {
    ...
    const contactButton = screen.getByRole('button', { name: /request premium quote/i })
  ...
  it('should handle services without starting price', () => {
    ...
    render(<ServiceCard service={serviceWithoutPrice} index={0} />)
